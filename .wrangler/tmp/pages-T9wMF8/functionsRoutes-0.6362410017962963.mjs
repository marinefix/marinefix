...
import { onRequest as __download_apk_ts_onRequest } from "D:\\MY 1ST PROJECT MARINE FIX\\marinefix-main\\functions\\download-apk.ts"
import { onRequest as __MarineFix_apk_ts_onRequest } from "D:\\MY 1ST PROJECT MARINE FIX\\marinefix-main\\functions\\MarineFix.apk.ts"
...
export const routes = [
  ...
  {
      routePath: "/download-apk",
      mountPath: "/",
      method: "",
      middlewares: [],
      modules: [__download_apk_ts_onRequest],
    },
  {
      routePath: "/MarineFix.apk",
      mountPath: "/",
      method: "",
      middlewares: [],
      modules: [__MarineFix_apk_ts_onRequest],
    },
  ]